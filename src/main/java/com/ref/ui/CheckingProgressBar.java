...
public class CheckingProgressBar extends JFrame implements FocusListener {
    ...
    private ImageIcon loadGif = new ImageIcon(getPath(new String[]{"src", "main", "java", "com", "com/ref", "ui", "icons", "loading.gif"}));
    private ImageIcon correctIco = new ImageIcon(getPath(new String[]{"src", "main", "java", "com", "com/ref", "ui", "icons", "ico_correct.png"}));
    private ImageIcon errorIco = new ImageIcon(getPath(new String[]{"src", "main", "java", "com", "com/ref", "ui", "icons", "ico_error.png"}));
